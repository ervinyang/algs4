 ...
 *  @link https://algs4.cs.princeton.edu/25applications/California.java.html
 *
 ******************************************************************************/
...
public class California {
    ...
    public static void main(String[] args) {
        String[] candidates = {"ROBERT BUTCH DOLE", "ROBERT C. NEWMAN", "ROBERT C. NEWMAN II", "ROBERT CULLENBINE", "RONALD J. FRIEDMAN", "RONALD JASON PALMIERI", "RANDALL D. SPRAGUE", "RALPH A. HERNANDEZ", "RICH GOSSE", "RICHARD J. SIMMONS", "REVA RENEE RENZ", "WARREN FARRELL", "WILLIAM BILL S. CHAMBERS", "LAWRENCE STEVEN STRAUSS", "LINGEL H. WINTERS", "LEO GALLAGHER", "LEONARD PADILLA"};
        int n = candidates.length;
        Arrays.sort(candidates, String.CASE_INSENSITIVE_ORDER);
        for (int i = 0; i < n; i++)
